//this will execute the code for quiz
...
function showQuetions(index){
    ...
    let que_tag = '<span>'+ questions[myArr[index]].question +'</span>';
    let option_tag = '<div class="option"><span>'+ questions[myArr[index]].options[0] +'</span></div>'
    + '<div class="option"><span>'+ questions[myArr[index]].options[1] +'</span></div>'
    + '<div class="option"><span>'+ questions[myArr[index]].options[2] +'</span></div>'
    + '<div class="option"><span>'+ questions[myArr[index]].options[3] +'</span></div>';
...
function optionSelected(answer){
    ...
    let correcAns = questions[myArr[que_count]].answer; //getting correct answer from array
